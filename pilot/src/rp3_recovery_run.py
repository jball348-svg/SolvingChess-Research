"""RP3-MR1: run the frozen RP3 procedure with durable I/O only."""
import argparse
import os
...
from rp3_durable import write_json, validate, sync_directory


class Run(rp3.Run):
    def __init__(self, args):
        super().__init__(args)
        self.report.update(experiment='RP3-MR1', original_experiment='BLOCKED',
